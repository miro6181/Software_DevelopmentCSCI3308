function openModal() {
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var passEqualsConfPass = ("password == confirmPassword"); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = ("letter == valid and capital == valid and number == valid and length == valid and match == valid"); // TODO: Replace false with the correct condition
    if(condition) {
